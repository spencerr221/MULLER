...
#
# Modifications Copyright (c) 2026 Xueling Lin, Bingyu Liu
...
from muller.util.exceptions import IncompatibleHtypeError, TensorMetaInvalidHtype
...
def parse_complex_htype(htype: Optional[Union[str, None]]):
    """Parse complex htype string and validate it."""
    if not htype:
