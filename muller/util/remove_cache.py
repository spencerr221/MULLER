...
# Source: https://github.com/activeloopai/deeplake/blob/94c5e100292c164b80132baf741ef233dd41f3d7/hub/util/remove_cache.py
#
...
def create_read_copy_dataset(dataset, commit_id: Optional[str] = None):
    ...
    ds = dataset.__class__(
        ...
        split_tensor_meta=dataset.split_tensor_meta,
    )
...
def get_dataset_with_zero_size_cache(ds):
    ...
    ds = muller.core.dataset.Dataset(
        path=ds.path,
